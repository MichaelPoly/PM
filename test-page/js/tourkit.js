...
$.ajax({
      ...
      success: function (data) {
       ...
       for (var i = 0; i < data.length; i++) {
         ...
         $('#kit' + i).append('<p id="nameInput' + i + '">' + data[i].kitName + '</p>');
         ...
         $('#kitName' + i).append('<input type="text" id="kitName' + i + 'Input" name="kitName" value="' + data[i].kitName + '" class="kitName">');
...
$('.addKit').on('click', function () {
  ...
  console.log($tourKit[$newId]);
  $('.kitBtnActive').removeClass("kitBtnActive").addClass("kitBtn");
  $('#kitShow').append('<div id="kit' + $newId + '" class="kitBtnActive"></div>');
  $('#kit' + $newId).append('<p id="nameInput' + $newId + '">' + $tourKit[$newId].kitName + '</p>');
  $('#interests').append('<div id="mainBlock' + $newId + '" class="mainBlock"></div>');
  $('#mainBlock' + $newId).append('<div id="kitHead' + $newId + '" class="kitHead"></div>');
  $('#kitHead' + $newId).append('<div id="kitHead' + $newId + 'Input" class="Input"></div>');
  $('#kitHead' + $newId + 'Input').append('<label for="kitName' + $newId + '">Название подборки</label>');
  $('#kitHead' + $newId + 'Input').append('<div id="kitName' + $newId + '" class="kitNameBox"></div>');
  $('#kitName' + $newId).append('<input type="text" id="kitName' + $newId + 'Input" name="kitName" value="' + $tourKit[$newId].kitName + '" class="kitName">');
  $('#kitHead' + $newId).append('<div class="spanDiv"></div>');
  $('#kitHead' + $newId).append('<div id="kitCity' + $newId + 'Input" class="select"></div>');
  $('#kitCity' + $newId + 'Input').append('<label for="cityName' + $newId + 'select">Ваш город</label>');
  $('#kitCity' + $newId + 'Input').append('<div id="cityName' + $newId + '" class="cityBlock"></div>');
  $('#cityName' + $newId).append('<select id="cityName' + $newId + 'select" class="citySelect" name="cityName' + $newId + 'select"></select>');
  for (var k = 0; k < $cityes.length; k++) {
    $('#cityName' + $newId + 'select').append('<option value="' + $cityes[k].city + '">' + $cityes[k].city + '</option>');
  }
  $('#cityName' + $newId + 'select').selectmenu().selectmenu( "menuWidget" ).addClass( "overflow" );

  $('#kitHead' + $newId).append('<div id="showResults' + $newId + '" class="showResults"></div>');
  $('#showResults' + $newId).append('<p>СМОТРЕТЬ РЕЗУЛЬТАТЫ <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></p>');

  $('#mainBlock' + $newId).append('<div id="country' + $newId + '" class="country"></div>');
  ...
  $('#country' + i).append('<div id="selectedCountry' + $newId + '" class="countrySelected"></div>');
    ...
    if ($tourKit[$newId].country1 != "") {
      $('#selectedCountry' + $newId).append('<div id="firstCountry' + $newId + '" class="countrySelectedBtn"></div>');
      $('#firstCountry' + $newId).append('<img src="' + $tourKit[$newId].flag1Href + '" alt="" style="height: 40%;">');
      $('#firstCountry' + $newId).append('<p>' + $tourKit[$newId].country1 + '</p>');
      $('#firstCountry' + $newId).append('<p id="firstCountry' + $newId + '" class="close">&#10006;</p>');
    }
    if ($tourKit[$newId].country2 != "") {
      $('#selectedCountry' + $newId).append('<div id="secondCountry' + $newId + '" class="countrySelectedBtn"></div>');
      $('#secondCountry' + $newId).append('<img src="' + $tourKit[$newId].flag2Href + '" alt="" style="height: 40%;">');
      $('#secondCountry' + $newId).append('<p>' + $tourKit[$newId].country2 + '</p>');
      $('#secondCountry' + $newId).append('<p id="secondCountry' + $newId + '" class="close">&#10006;</p>');
    }
    if ($tourKit[$newId].country3 != "") {
      $('#selectedCountry' + $newId).append('<div id="thirdCountry' + i + '" class="countrySelectedBtn"></div>');
      $('#thirdCountry' + $newId).append('<img src="' + $tourKit[$newId].flag3Href + '" alt="" style="height: 40%;">');
      $('#thirdCountry' + $newId).append('<p>' + $tourKit[$newId].country3 + '</p>');
      $('#thirdCountry' + $newId).append('<p id="thirdCountry' + $newId + '" class="close">&#10006;</p>');
    }
    if ($tourKit[$newId].country4 != "") {
      $('#selectedCountry' + $newId).append('<div id="fourthCountry' + i + '" class="countrySelectedBtn"></div>');
      $('#fourthCountry' + $newId).append('<img src="' + $tourKit[$newId].flag4Href + '" alt="" style="height: 40%;">');
      $('#fourthCountry' + $newId).append('<p>' + $tourKit[$newId].country4 + '</p>');
      $('#fourthCountry' + $newId).append('<p id="fourthCountry' + $newId + '" class="close">&#10006;</p>');
    }

  $('#mainBlock' + $newId).append('<div id="chengeSelect' + $newId + '" class="chengeSelect"></div>');
  $('#chengeSelect' + $newId).append('<div id="addRegionBtn' + $newId + '" class="btnSelect"></div>');
  $('#addRegionBtn' + $newId).append('<p>ДОБАВИТЬ РЕГИОН</p>');
  $('#chengeSelect' + $newId).append('<div id="addCountryBtn' + $newId + '" class="btnSelect"></div>');
  $('#addCountryBtn' + $newId).append('<p>ДОБАВИТЬ СТРАНЫ</p>');

  $('#mainBlock' + $newId).append('<div id="tourDetails' + $newId + '" class="tourDetails"></div>');
  $('#tourDetails' + $newId).append('<div id="startEndDate' + $newId + '" class="startEndDate"></div>');
  $('#startEndDate' + $newId).append('<label for="SEDate' + $newId + 'Input">Дата вылета</label>');
  $('#startEndDate' + $newId).append('<div id="tourDetailsDate' + $newId + '" class="tourDetailsItems"></div>');
  $('#tourDetailsDate' + $newId).append('<input type="text" id="SEDate' + $newId + 'Input" name="SEDate" value="" class="SEDate1">');

  $('#tourDetails' + $newId).append('<div id="numOfDays' + $newId + '" class="numOfDays"></div>');
  $('#numOfDays' + $newId).append('<label for="days' + $newId + 'Input">На сколько</label>');
  $('#numOfDays' + $newId).append('<div id="tourDetailsDays' + $newId + '" class="tourDetailsItems"></div>');
  $('#tourDetailsDays' + $newId).append('<input type="text" id="days' + $newId + 'Input" name="days" value="' + $tourKit[$newId].qNights + ' ночей" class="nDays">');

  $('#tourDetails' + $newId).append('<div id="people' + $newId + '" class="people"></div>');
  $('#people' + $newId).append('<label for="peopleNum' + $newId + 'Input">Количество гостей</label>');
  $('#people' + $newId).append('<div id="tourDetailsPeople' + $newId + '" class="tourDetailsItems"></div>');
  $('#tourDetailsPeople' + $newId).append('<input type="text" id="peopleNum' + $newId + 'Input" name="peopleNum" value="' + $tourKit[$newId].qFullAge + ' взрослых, ' + $tourKit[$newId].qChild + ' детей" class="peopleNum">');

  $('#tourDetails' + $newId).append('<div id="costRange' + $newId + '" class="costRange"></div>');
  $('#costRange' + $newId).append('<label for="costRange' + $newId + 'Input">Стоимость тура</label>');
  $('#costRange' + $newId).append('<div id="tourDetailsCost' + $newId + '" class="tourDetailsItems"></div>');
  $('#tourDetailsCost' + $newId).append('<input type="text" id="costRange' + $newId + 'Input" name="costRange" value="' + $tourKit[$newId].costFrom + ' Р - ' + $tourKit[$newId].costTo + ' Р" class="costRangeI">');

  $('#mainBlock' + $newId).append('<div id="hotelDesc' + $newId + '" class="hotelDesc"></div>');
  $('#hotelDesc' + $newId).append('<div id="hotelStar' + $newId + '" class="hotelStar"></div>');
  $('#hotelStar' + $newId).append('<p id="hotelsStar' + $newId + '" class="hotels">Категория отелей от</p>');
  $('#hotelStar' + $newId).append('<div id="stars' + $newId + '" class="stars"></div>');

  var $starRate = $tourKit[$newId].starsFrom;
  for (var n = 0; n < 5; n++) {
    if (n < $starRate) {
      $('#stars' + $newId).append('<p id="Star'+ n + $newId + '" style=" color: #ffcc00;">&#9733;</p>');
    } else {
      $('#stars' + $newId).append('<p id="Star'+ n + $newId + '">&#9733;</p>');
    }
  }

  $('#hotelDesc' + $newId).append('<div id="hotelRate' + $newId + '" class="hotelRate"></div>');
  $('#hotelRate' + $newId).append('<p id="hotelsRate' + $newId + '" class="hotels">Рейтинг TopHotels</p>');
  $('#hotelRate' + $newId).append('<div id="rate' + $newId + '" class="rate"></div>');
  $('#rate' + $newId).append('<pre>Не ниже </pre><img src="img/crown.svg" alt="" style="height: 40%;"><pre> </pre>');
  $('#rate' + $newId).append('<p id="rateNum' + $newId + '" class="rateNum">' + $tourKit[$newId].rateFrom + '</p>');

  $('#hotelDesc' + $newId).append('<div id="meal' + $newId + '" class="meal"></div>');
  $('#meal' + $newId).append('<p id="hotelsMeal' + $newId + '" class="hotels">Тип питания</p>');
  $('#meal' + $newId).append('<div id="mealType' + $newId + '" class="mealType"></div>');
  $('#mealType' + $newId).append('<input type="text" id="meal' + $newId + 'Input" name="meal" value="' + $tourKit[$newId].meal + '" class="mealInput">');

  $('#hotelDesc' + $newId).append('<div id="position' + $newId + '" class="position"></div>');
  $('#position' + $newId).append('<p id="hotelsPosition' + $newId + '" class="hotels">Расположение</p>');
  $('#position' + $newId).append('<div id="positionType' + $newId + '" class="positionType"></div>');
  $('#positionType' + $newId).append('<input type="text" id="position' + $newId + 'Input" name="position" value="' + $tourKit[$newId].positionType + '" class="positionInput">');

  $('#hotelDesc' + $newId).append('<div id="delKit' + $newId + '" class="delKit"></div>');
  $('#delKit' + $newId).append('<p id="delKitBtn' + $newId + '" class="delKitBtn"><i class="fa fa-times-circle" aria-hidden="true"></i> УДАЛИТЬ ПОДБОРКУ</p>');
  $('#kit' + $newId).on('click', function () {
    var $idNum = this.id[3];
    $('.kitBtnActive').removeClass("kitBtnActive").addClass("kitBtn");
    $('#' + this.id).removeClass("kitBtn");
    $('#' + this.id).addClass("kitBtnActive");
